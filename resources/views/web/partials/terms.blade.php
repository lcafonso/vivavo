...
<div class="container">
	<div class="row">
		...
		<div class="col">
			...
			<div style="border:1px solid black;width:100%;height:600px;overflow-y:scroll;overflow-x:hide;padding: 15px 25px 15px 25px;">
				...
				<h3>VISÃO GERAL</h3>
				<p>
				Esse site é operado pelo Projecto Vivavó. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Projecto Vivavó. O Projecto Vivavó proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.	
				</p>
				<p>
				...
				<strong>SEÇÃO 1 - TERMOS DA LOJA VIRTUAL</strong>
				<p>
				...
				<strong>SEÇÃO 3 - PRECISÃO, INTEGRIDADE E ATUALIZAÇÃO DAS INFORMAÇÕES</strong>
				...
				<strong>SEÇÃO 13 - ISENÇÃO DE RESPONSABILIDADE DE GARANTIAS; LIMITAÇÃO DE RESPONSABILIDADE</strong>
				...
				<p>
				Esses Termos de serviço e quaisquer acordos separados em que nós lhe fornecemos os Serviços devem ser regidos e interpretados de acordo com as leis de Campus do Cruzeiro - Avenida 25 de Abril, Cruzeiro, Lote 2., Mirandela, 04, 5370-202, Portugal.
				</p>
				...
				<p>
				As perguntas sobre os Termos de serviço devem ser enviadas para nós através do vivavo@ipb.pt.
				</p>

			
			</div>
			<a href="{{ URL::previous() }}" class="float-right">Voltar</a>
		</div>
	</div>
</div>
